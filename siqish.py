...
# === Parametrlar ===
video_path = "814.mp4"
output_path = "compressed_output-814.mp4"
...
# H.264 kodek bilan siqish
command = f'"{ffmpeg_path}" -i "{video_path}" -c:v libx264 -preset slow -crf 23 -c:a aac -b:a 128k "{output_path}" -progress - -nostats'
...
print("Siqish jarayoni boshlandi...\n")
...
process.wait()
print("\n✅ Siqish tugadi! Fayl:", output_path)
